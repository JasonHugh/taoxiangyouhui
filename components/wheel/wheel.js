...
class Wheel {
   ...
   */
    constructor (pageContext, opts) {
      ...
      this.awardNumers = opts.awardNumers; // 中奖区域数组 从1开始
      var random = Math.floor(Math.random() * this.awardNumers.length);
      this.awardNumer = this.awardNumers[random]
